...
VALUES ('Deepak', 'Mishra', 'ADMIN', true, 'admin', 'dm@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Atul', 'Verma', 'SUPPLIER', true, '12345', 'av@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Dheeraj', 'Tiwari', 'SUPPLIER', true, '12345', 'dt@gmail.com', '7777777777');
